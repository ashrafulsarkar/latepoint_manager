...
define('LATEPOINT_MANAGER_ADDON_VER', '1.1.0');
...
class LatePoint_Manager_Addon_Preload {
    ...
    public function __construct() {
        if (class_exists('LatePoint')) {
            add_action('init', array($this, 'LatePoint_Manager_load'));
            add_action('init', array($this, 'lp_m_latepoint_main_plugin_reactive'));
        }
        if (!class_exists('LatePoint')) {
