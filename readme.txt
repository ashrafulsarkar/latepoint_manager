...
* [Easy Login Logout][easy-login-logout] - Control Login Logout Menu
[easy-login-logout]: https://wordpress.org/plugins/easy-login-logout/ "Control Who Can Access Menu"
* [First Order Discount in WooCommerce][first-order-coupon-manager-for-woocommerce] - First Order Discount in WooCommerce
[first-order-coupon-manager-for-woocommerce]: https://wordpress.org/plugins/first-order-coupon-manager-for-woocommerce/ "First Order Discount in WooCommerce"
...
2. Extract "latepoint_manager.zip" archive content to the "/wp-content/plugins/latepoint_manager" directory.
3. Activate "LatePoint Manager" plugin via 'Plugins' menu in WordPress admin menu.
...
== Changelog ==
= 1.2.0 =
* Fixed: Admin Notice Problem.
* Bug fix: Some bug fixed. 
= 1.1.0 =
